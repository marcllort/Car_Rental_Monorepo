...
public class Cronjob {
    ...
    void routePaperFlow(CalendarEvent event) throws JsonProcessingException {
        ...
        apiservice.car.model.Service service = objectMapper.readValue(calendarResponse.getText(), apiservice.car.model.Service.class);
    ...
    void invoiceFlow(CalendarEvent event) throws JsonProcessingException {
        ...
        apiservice.car.model.Service service = objectMapper.readValue(json, apiservice.car.model.Service.class);
